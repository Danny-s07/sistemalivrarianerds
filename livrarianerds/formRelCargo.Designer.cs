namespace livrarianerds
{
    partial class formRelCargo
    {
        ...
        private void InitializeComponent()
        {
            ...
            // 
            this.classCargoBindingSource.DataSource = typeof(livrarianerds.classCargo);
            // 
            // reportViewer1
            // 
            this.reportViewer1.Dock = System.Windows.Forms.DockStyle.Fill;
            reportDataSource1.Name = "DSCargo";
            reportDataSource1.Value = this.classCargoBindingSource;
            this.reportViewer1.LocalReport.DataSources.Add(reportDataSource1);
            this.reportViewer1.LocalReport.ReportEmbeddedResource = "livrarianerds.rptCargo.rdlc";
            this.reportViewer1.Location = new System.Drawing.Point(0, 0);
            this.reportViewer1.Margin = new System.Windows.Forms.Padding(4, 4, 4, 4);
            this.reportViewer1.Name = "reportViewer1";
            this.reportViewer1.ServerReport.BearerToken = null;
            this.reportViewer1.Size = new System.Drawing.Size(637, 532);
            ...
            this.Text = "Relatorio Cargo";
            this.Load += new System.EventHandler(this.RelCargo_Load);
