...
namespace livrarianerds
{
    public partial class formRelFuncionario : Form
    {
        ...
        private void RelFuncionario_Load(object sender, EventArgs e)
        {

            //carregar combo categoria
            classFuncionario cfuncionario = new classFuncionario();
            //combo recebendo select
            cbcidade.DataSource = cfuncionario.RelCarregarcidade();
            ...
            this.rptfuncionario.RefreshReport();
        }
        ...
        private void btgerarRelatorio_Click(object sender, EventArgs e)
        {
            ...
            {
                   classfuncionarioBindingSource.DataSource = cfuncionario.RelFuncionarioAniversarioDiaMes(cbdia.SelectedIndex, cbmes.SelectedIndex);
                        this.rptfuncionario.RefreshReport();
            }
            else
            {
              MessageBox.Show("Por Favor escolher um dia e um mês", "Atenção!", MessageBoxButtons.OK , MessageBoxIcon.Exclamation);        
                ...
                case "Aniversariantes do Mês":
                    ...
                    {
                        classfuncionarioBindingSource.DataSource = cfuncionario.RelFuncionarioAniversariMes(cbmes.SelectedIndex);
                        this.rptfuncionario.RefreshReport();
                    }
                ...
                case "Idade":
                    ...
                    {
                        classfuncionarioBindingSource.DataSource = cfuncionario.RelFuncionarioidade(Convert.ToInt32(txtDe.Text), Convert.ToInt32(txtAte.Text));
                        this.rptfuncionario.RefreshReport();
                    }
                ...
                case "Sexo":
                    ...
                    {
                        classfuncionarioBindingSource.DataSource = cfuncionario.RelFuncionarioSexo(cbsexo.SelectedItem.ToString());
                        this.rptfuncionario.RefreshReport();
                    }
                    else
                    {
